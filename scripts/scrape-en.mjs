...
const BASE = "https://www.consultajoelho.pt/en";
const UA =
...
await writeFile("content/scraped-en.json", JSON.stringify(out, null, 2), "utf8");
console.log(`\nGuardado content/scraped-en.json (${out.length} páginas)`);
