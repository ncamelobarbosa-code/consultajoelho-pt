...
export default function Locais({ lang = "pt" }: { lang?: Lang }) {
  ...
  return (
    <section aria-label="Locais" className="home-band" style={{ background: "var(--white, #fff)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", padding: "3cm 1.5rem" }}>
